...
if __name__ == "__main__":
    ...
    ap.add_argument("--out_vocab", type=str, default=str(Path("data")/"processed"/"derja_ninja_words.json"))
    ap.add_argument("--out_raw", type=str, default=str(Path("data")/"raw"/"derja_ninja_pages.jsonl"))
    ap.add_argument("--out_cards", type=str, default=str(Path("data")/"raw"/"derja_ninja_cards.jsonl"))
    args = ap.parse_args()
