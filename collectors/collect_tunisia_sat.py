...
if __name__ == "__main__":
    ...
    ap.add_argument("--out_vocab", type=str, default=str(Path("data")/"processed"/"tunisia_sat_words.json"))
    ap.add_argument("--out_raw", type=str, default=str(Path("data")/"raw"/"tunisia_sat_pages.jsonl"))
    ap.add_argument("--out_posts", type=str, default=str(Path("data")/"raw"/"tunisia_sat_posts.jsonl"))
    args = ap.parse_args()
