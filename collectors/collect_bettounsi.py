...
if __name__ == "__main__":
    ...
    ap.add_argument("--out_vocab", type=str, default=str(Path("data")/"processed"/"bettounsi_words.json"))
    ap.add_argument("--out_raw", type=str, default=str(Path("data")/"raw"/"bettounsi_pages.jsonl"))
    args = ap.parse_args()
